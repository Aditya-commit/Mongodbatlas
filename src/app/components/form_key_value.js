...
const FormKeyvalue = ({id , keyName , keyValue , valueName , valueData , handleKeyChange , handleValueChange , deletePair}) => {
    ...
    return(
        ...
        <div className='grid grid-cols-[200px_max-content_200px_max-content] items-center space-x-3'>
            ...
            <input type='text' name={keyName} className={`text-yellow-600 ${nunito_sans.className} text-lg font-[600] border-b-2 border-gray-300 px-3 py-1 outline-none focus-visible:border-yellow-500`} placeholder='key' value={keyValue} onChange={handleKeyChange} />
            <span>:</span>
            <input type='text' name={valueName} className={`text-black ${nunito_sans.className} text-lg font-[600] border-b-2 border-gray-300 px-3 py-1 outline-none focus-visible:border-black`} placeholder='value' value={valueData} onChange={handleValueChange} />
